...
HELP_STRING = f"˹𝕁𝔸𝔻𝕌𝔾𝔸ℝ ✘ 𝕊ℙ𝔸𝕄˼🫧 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★\n\n» **𝐂𝐋𝐈𝐂𝐊 𝐎𝐍 𝐁𝐔𝐓𝐓𝐎𝐍 𝐅𝐎𝐑 𝐇𝐄𝐋𝐏**\n» **𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥: ˹˹𝕁𝔸𝔻𝕌𝔾𝔸ℝ ✘ 𝕊ℙ𝔸𝕄˼🫧**"
...
HELP_BUTTON = [
    ...
    [
      ...
      Button.url("★𝗦𝗨𝗣𝗣𝗢𝗥𝗧★", "https://t.me/NOBITA_H")
    ],
  [   
...
async def help_spam(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("★𝐏𝐋𝐄𝐀𝐒𝐄 𝐉𝐎𝐈𝐍 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏 𝐀𝐍𝐃 𝐓𝐀𝐆 @jadugar_25", cache_time=0, alert=True)
