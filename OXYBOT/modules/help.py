...
HELP_BUTTON = [
    ...
    [
      Button.url("★𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥★", "https://t.me/IAMJADUGAR") ,
      Button.url("★𝗦𝗨𝗣𝗣𝗢𝗥𝗧★", "https://t.me/+https://t.me/+GU3aHp-TW-RkMjZl")
    ],
  [   
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://telegra.ph/file/d7141e64004be5e521e31.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
    ...
    if event.query.user_id in SUDO_USERS:    
        await event.edit(
            ...
            buttons=[
              ...
              [
                Button.url("★𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥★", "https://t.me/IAMJADUGAR"),
                Button.url("★𝗦𝗨𝗣𝗣𝗢𝗥𝗧★", "https://t.me/+GU3aHp-TW-RkMjZl")
              ]
            ]
          )
    else:
        await event.answer("★ 𝑮𝑹𝑶𝑼𝑷 𝑱𝑶𝑰𝑵 𝑲𝑨𝑹 𝑶𝑹 𝑺𝑼𝑫𝑶 𝑴𝑨𝑵𝑮 𝑼𝑫𝑯𝑨𝑹 💕★" , cache_time=0, alert=True)
